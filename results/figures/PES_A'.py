...
e_pro = np.loadtxt('A1-energy_profile.txt')
ept = e_pro[:,0]
epr = e_pro[:,1]
...
figure_fig = plt.gcf()
figure_fig.savefig('A1.pdf', format='pdf', dpi=1000)
...
e_pro = np.loadtxt('A1-energy_profile_curve.txt')
ept = e_pro[:,0]
epr = e_pro[:,1]
...
figure_fig = plt.gcf()
figure_fig.savefig('A1-energy_profile.pdf', format='pdf', dpi=1000)